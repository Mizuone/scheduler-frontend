...
import { DayTestId } from "../../../tests/data-test-ids";
...
export const Day = (props: DayProps) => {
    ...
    const testId = `${DayTestId}-${day.dayOfWeek}`;
    ...
    const renderTimeSlots = () => {
        return normalDayHours.map((dayHour, index) => {
            ...
            const renderTimeSlot = (minute: string) => {
                ...
                return (
                    <Box 
                        onClick={(e) => onTimeRangeClicked(e, startTime)}
    ...
    return (
        <Box data-testid={testId} position={"relative"} width={"100%"}>
            {
                renderTimeSlots()
            }
            {/* {isModalOpen && (
